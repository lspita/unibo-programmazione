...
void prepareField(unsigned int fieldY, unsigned int fieldX, char field[fieldY][fieldX])
{
...
bool randomStep(struct Point *currentPos, unsigned int fieldY, unsigned int fieldX, char field[fieldY][fieldX])
{
    ...
    do
    {
        ...
        // loop over movements, counter is used as index translator to only possible movements remaining
