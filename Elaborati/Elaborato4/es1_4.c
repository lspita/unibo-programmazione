// Abbiamo corretto la stampa dei byte ma riguardo l'intersezione con duplicati
// non abbiamo trovato errori. Abbiamo quindi chiesto conferma alla prof.ssa
// Carbonaro e anche a lei risulta corretto.
...
int *findIntersection(int a1[], int a2[], int len1, int len2, int Dup,
                      int *NewLen) {
...
int *findUnion(int arr1[], int arr2[], int len1, int len2, int Dup,
               int *NewLen) {
...
int main() {
  ...
  int *interArrayDup =
      findIntersection(array1, array2, len1, len2, 1, &interLenDup);
