...
int main()
{
    ...
    do
    {
        printf("digitare il MINIMO del range che deve comprendere il tuo numero (estremi inclusi) e premere invio: \n");
        fflush(stdin);
        scanf("%d", &min);
    } while (min < 0);
    ...
    {
        printf(
            "digitare il MASSIMO del range che deve comprendere il tuo numero (estremi inclusi) e premere invio: \n");
        fflush(stdin);
        scanf("%d", &max);
    } while (max <= (min + 1));
    ...
    while (fine == 0)
    {
        ...
        else
        {
            ...
            else
            {
                do
                {
                    printf("il numero a cui stai pensando e' piu' grande o piu' piccolo di %d? [g/p]\n", q);
                    fflush(stdin);
                    scanf("%c", &risposta);
